...
* The original package name 'com.shingle.user-auth-cas' is invalid and this project uses 'com.shingle.user_auth_cas' instead.
...
```
$ docker run --rm -p 8080:8080 user-auth-cas:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/user-auth-cas
```
